...
For `String` data types, you are able to specify the underlying :docs-link[Database Data Type]{id="projects/automation/datastores/tables/database_data_types"}.
